...
- Inference loop now working, see: `./infer/async.py`
...
- Played around with:
  ...
  - `--max-relative-target` (./infer/async.py > line 623)
...
path = './ckpt/PIv3/model.safetensors'
...
- Resolving this warning might be worth looking into as well: `WARNING: No normalization stats loaded for inputs!`
